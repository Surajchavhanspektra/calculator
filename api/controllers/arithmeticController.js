...
exports.calculate = function(req, res) {
  ...
  //In addition, include a comment on the preceding line stating // Using + operator to type cast variables as integers in order to prevent string concatenation`
  var operations = {
